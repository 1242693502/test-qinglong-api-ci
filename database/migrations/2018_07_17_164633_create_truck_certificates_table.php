...
class CreateTruckCertificatesTable extends Migration {
	...
	public function up()
	{
		Schema::create('truck_certificates', function(Blueprint $table)
		{
			$table->increments('id')->comment('车辆证件照自增ID');
	...
	{
		Schema::drop('truck_certificates');
	}
