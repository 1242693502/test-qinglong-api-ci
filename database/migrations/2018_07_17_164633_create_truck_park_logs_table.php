...
class CreateTruckParkLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('truck_park_logs', function(Blueprint $table)
		{
			$table->increments('id')->comment('车辆停车自增ID');
