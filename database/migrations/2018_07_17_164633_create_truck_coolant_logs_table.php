...
class CreateTruckCoolantLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('truck_coolant_logs', function(Blueprint $table)
		{
			...
			$table->integer('liter_number')->nullable()->comment('冷却液升数（单位：升）');
	...
	{
		Schema::drop('truck_coolant_logs');
	}
