...
class CreateTruckRepairLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('truck_repair_logs', function(Blueprint $table)
		{
			...
			$table->integer('repair_type_id')->nullable()->comment('类型ID');
			$table->char('name', 32)->nullable()->comment('名称');
