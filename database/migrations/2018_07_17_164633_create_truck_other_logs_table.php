...
class CreateTruckOtherLogsTable extends Migration {
	...
	public function up()
	{
		Schema::create('truck_other_logs', function(Blueprint $table)
		{
			$table->increments('id')->comment('车辆其他自增ID');
