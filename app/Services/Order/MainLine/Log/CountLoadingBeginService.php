...
class CountLoadingBeginService extends BaseService
{
    /**
     * 记录装货计时开始
     *
    ...
    public function create($orderUUID, $driverUUID, $parameters = [])
    {
        ...
        //记录$parameters
        $description      = '装货计时开始，装货地：' . $data['full_address'];
        $orderMainLineLog = (new LogService())->logCountLoadingBegin($orderMainLine, $driverUUID,
