...
class HighWayEnterService extends BaseService
{
    /**
     * 记录进入高速
     *
    ...
    public function create($orderUUID, $driverUUID, $parameters = [])
    {
        ...
        // 检查是否允许操作
        $this->checkActionAllow($orderUUID, 'high_way_enter');
        ...
        //记录$parameters
        $description      = '记录进入高速';
        $orderMainLineLog = (new LogService())->logHighWayEnter($orderMainLine, $driverUUID, $parameters, [
