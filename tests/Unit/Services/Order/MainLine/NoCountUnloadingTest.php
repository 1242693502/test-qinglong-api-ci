...
class NoCountUnloadingTest extends TestCase
{
    /**
     * 测试甩挂无需计时
     *
     ...
     */
    public function testNoCountUnloading($orderMainLine, $truckDriverData)
    {
        ...
        $orderMainlineLog = [
            ...
            'description' => '甩挂无需计时，卸货地：' . $orderMainLinePlace->area_name . $orderMainLinePlace->address,
            'remark'      => '测试甩挂无需计时',
        ...
        $this->assertTrue(ActionService::serviceForOrderUUID($orderUUID)->stage()->isActionDone('count_unloading_begin'));
    }
}
